...
<body class="bg-gray-100">
    ...
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            <div class="hidden xl:flex flex-col min-h-screen bg-blue-500 p-4">
                ...
                <div class="my-auto text-center">
                    @php
                        ...
                        $appName = DB::table('systemflag')
                            ...
                            ->first();
                    @endphp
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16 rounded-full" src="/{{ $logo->value }}"
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 xl:hidden text-center">Astrology Prediction by Astrologers</div>
