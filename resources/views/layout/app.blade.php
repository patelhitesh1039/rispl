    ...
    <nav id="pageheader"class="navbar navbar-expand-lg  theme-nav fixed-top">
        ...
        <div class="container" style="display:initial!important">
            ...
            <a class="navbar-brand" href="{{ url('home') }}#home" [pageScrollOffset]="75" pageScroll><img
                    ...
                    src="/build/assets/images/logo.png" alt="logo"

                    style="height: 50px;width: 50px;vertical-align: middle !important;"><span

                    style="font-size:42px;color:#fff;vertical-align: middle !important;">&nbsp;AstroLiveChat</span></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <div class="social-footer">
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.facebook.com/astrolivechat"><i aria-hidden="true" class="fa fa-facebook"></i></a></li>

                            <li><a ><i aria-hidden="true" class="fa fa-twitter"></i></a></li>

                            <li><a href="https://www.instagram.com/astro.livechat" target="_blank"><i aria-hidden="true" class="fa fa-instagram"></i></a></li>
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p class="copyright">Copyright by AstroLiveChat </p>
