        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 xl:hidden text-center">Astrology Prasasdasdasdediction
                        by Astrologers</div>
                    ...
                    <button
                        class="mt-4 btn btn-primary btn-submit py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Login2332</button>
                    </form>
